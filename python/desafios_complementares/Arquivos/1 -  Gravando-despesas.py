'''Escreva um programa Python que permita ao usuário registrar suas despesas diárias em um arquivo de texto chamado "expenses.json". O programa deve permitir que o usuário insira a descrição da despesa e o valor gasto. Então você precisa salvar esses dados em um arquivo no seguinte formato:

"Data: {data} - Descrição: {descrição} - Quantidade: {quantidade}"

Onde data é a data atual e descrição e quantidade são os dados inseridos pelo usuário.
'''
